...
class MemoryGame extends JFrame implements ActionListener {
    ...
    void iniciaTimer(){
        int resposta = JOptionPane.showConfirmDialog(desktop, "Clique 'YES' para iniciar o cronometro!", "Preparado?", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE, new ImageIcon(Cartas.class.getResource("/Resources/relogio.png")));
    ...
    public static void main(String[] args) {
        MemoryGame tela = new MemoryGame();
    }
}
